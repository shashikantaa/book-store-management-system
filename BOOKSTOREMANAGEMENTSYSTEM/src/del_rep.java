 ...
 * @author Hp
 */
public class del_rep extends javax.swing.JFrame {

    /** Creates new form DELIVERED_ED */
    public del_rep() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("DELIVERY REPORTS ");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            String sql="select * from delivery where DATE = '"+jTextField2.getText()+"'";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            con= DriverManager.getConnection(url,user,pass);
            Statement st = con.createStatement();
            String sql="select * from delivery where ORDERID = '"+bid+"' ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(del_rep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
